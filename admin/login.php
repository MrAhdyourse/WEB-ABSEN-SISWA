...
<head>
    ...
    <title>ABSENSI SISWA - SMK NU INDRAMAYU</title>
...
<body class="bg-gray-900 min-h-screen flex items-center justify-center bg-[url('../assets/default/bg-pattern.png')] bg-repeat">
    ...
    <div class="max-w-md w-full mx-4 relative z-10">
        ...
        <div class="text-center mb-8">
            <img src="../assets/default/LogoSMKNU.png" alt="SMK NU INDRAMAYU"
            ...
            <p class="text-gray-400">Sistem Absensi SMK NU INDRAMAYU</p>
        </div>
        ...
        <div class="text-center mt-8 text-gray-400 text-sm">
            <p>&copy; <?= date('Y') ?> SMK NU INDRAMAYU</p>
